  ...
  <div className="cs-blog-detail">
      ...
      <div className="cs-post-title">
          ...
          <div className="post-option">
              ...
              <span className="post-date"><a href="http://jobcareer.chimpgroup.com/jobdoor/2015/11/"><i className="cs-color icon-calendar6"></i>Nov 23, 2015</a></span>
              <span className="post-comment"><a href="http://jobcareer.chimpgroup.com/jobdoor/experience-writing-for-producing-a-newscast/#comments"><i className="cs-color icon-chat6"></i>4 Comments</a></span>
          </div>
      </div>
          ...
          <div className="rich-editor-text">
              ...
              <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <blockquote className="text-left-align">
                      ...
                      <span className="author-name"> <a href="#">-- Robert Deneairo</a></span>
                  </blockquote>
              </div>
              <p>Ravenously while stridently coughed far promiscuously below jeez much yikes bland that salamander cunningly some over abhorrent as house with between ouch that well scurrilously alas capybara massive outdid oh said hello majestically roadrunner lobster much bled alas lighted together waved upheld.</p>
          </div>
